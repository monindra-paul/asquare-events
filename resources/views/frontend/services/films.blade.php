            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="position-re">
                        <h6 class="dot-titl mb-10">Asquare Films & Entertainments</h6>
                        <h2 class="fz-70 fw-700">Our Services</h2>
                    </div>
                </div>
                <div class="col-lg-4 d-flex align-items-center">
                    <div class="text">
                        <p>We believe that every story deserves to be told with passion and authenticity, and our talented filmmakers are committed to bringing your vision to the silver screen.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-5">
                <div class="item md-mb80">
                    ...
                    <div class="cont mt-30 d-flex">
                        <div>
                            <h6 class="line-height-1">TVC</h6>
                            <p>TV Commercial</p>
                        </div>
                        <div class="ml-auto">
                            <p class="fz-14">© Asquare</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="item full-width">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1">Short Films</h6>
                                    <p>Short Films</p>
                                </div>
                                <div class="ml-auto">
                                    <p class="fz-14">© Asquare</p>
                ...
                <div class="item mt-80">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1">Web Series</h6>
                                    <p>Web Series</p>
                                </div>
                                <div class="ml-auto">
                                    <p class="fz-14">© Asquare</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="sec-lg-head mb-80">
                    <div class="position-re">
                        <h6 class="dot-titl-non mb-10 wow fadeIn">Our Own Production House</h6>
                        <h2 class="fz-50 d-rotate wow">
                            <span class="rotate-text">Asquare Films & Entertainments</span>
                        </h2>
                        <p>We are also running an Advertising / Creative House & Production House Asquare Films & Entertainment. in Kolkata to make home production Events Creative, Movies & Videos, and also engage in Branding and Promotions.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 items web info-overlay mb-50">
                    <div class="item-img o-hidden">
                        ...
                        <div class="info">
                            ...
                            <h6 class="sub-title tag">© 2023 <br> Design ART</h6>
