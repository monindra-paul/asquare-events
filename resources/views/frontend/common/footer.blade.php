            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="logo">
                            <a href="#0">
                                <img src="{{asset('assets/imgs/asquare/logo/asquaregra.png')}}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="copyright d-flex">
                            <div class="ml-auto">
                                <p class="fz-13">© 2023 Asquare - <span class="underline"><a
                                            href="https://ecoretechserv.com/" target="_blank">Developed By
                                            ECore TechServ</a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
