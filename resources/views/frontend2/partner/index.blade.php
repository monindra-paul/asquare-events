        ...
        <div class="cs-side_header_box">
            ...
            <ul class="cs-contact_info cs-style1 cs-mp0">
                ...
                <li>
                    ...
                    <span>info@teamasquare.com</span>
                </li>
                <li>
...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/contact_hero_bg.jpeg">
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color">Become a Partner</h1>
...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            ...
            <ul class="cs-contact_info cs-style1 cs-mp0">
                ...
                <li>
                    ...
                    <span> infoasquare.kol@gmail.com </span>
                </li>
                <li>
                    <svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class="col-lg-6">
            <form id="cs-form" action="{{url('/partner')}}" method="POST" class="row" enctype="multipart/form-data">
                @csrf               

                
                <div class="col-sm-6">
                    <label class="cs-primary_color">Full Name*</label>
                    <input type="text" class="cs-form_field" name="name" id="name" >
                    @if ($errors->has('name'))
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="cs-form_field" name="email" id="email" >
                    @if ($errors->has('email'))
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="cs-form_field" name="mobile" id="mobile" >
                ...
                <div class="col-sm-6">
                    <label class="cs-primary_color">State*</label>
                    <input type="text" class="cs-form_field" name="state" id="state" >
                    @if ($errors->has('state'))
                ...
                <div class="col-sm-6">
                    <label class="cs-primary_color">City*</label>
                    <input type="text" class="cs-form_field" name="city" id="city" >
                    @if ($errors->has('city'))
                ...
                <div class="col-sm-6">
                    <label class="cs-primary_color">Country*</label>
                    <input type="text" class="cs-form_field" name="country" id="country" >
                ...
                <div class="col-lg-12">
                    <label class="cs-primary_color">Pin*</label>
                    <input type="text" class="cs-form_field" name="pin" id="pin" >
                    @if ($errors->has('pin'))
                ...
                <!-- <div class="col-sm-6">
                    <label class="cs-primary_color">Country*</label>
                    <select class="form-select form-select-sm cs-primary_color" aria-label=".form-select-sm example">
                        <option class="cs-form_field" selected>Open this select menu</option>
                        <option class="cs-form_field" value="1">One</option>
                        <option class="cs-form_field" value="2">Two</option>
                        <option class="cs-form_field" value="3">Three</option>
                    </select>
                </div> -->
                <div class="col-lg-12">
                    <label class="cs-primary_color">Address*</label>
                    <input type="text" class="cs-form_field" name="address" id="address" >
                ...
                <div class="col-lg-12">
                    <label class="cs-primary_color">Describe Yourself*</label>
                    <textarea cols="30" rows="7" class="cs-form_field" name="description" id="description" ></textarea>
                ...
                <div class="col-lg-12">
                    ...
                    <label class="cs-primary_color">Upload your Portfolio*</label>
                    <input type="file" class="cs-form_field" name="upload" id="upload">
