...
<body>
        ...
        <div class="cs-main_header_in">
          <div class="cs-main_header_left">
            <a class="cs-site_branding" href="{{url('/')}}">
              <img src="{{('assets/img/asquare/logo/asquare-pink.webp')}}" alt="Logo"  />
            </a>
          </div>
              ...
              <ul class="cs-nav_list">
                ...
                <li class="menu-item-has-children">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="{{ url('/filmsentertaiment') }}">Film & Entertainments</a>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <a href="{{ url('/asquare-wedding') }}">Asquare Wedding</a>
                    </li>
                    <li>
  ...
  <div class="cs-side_header">
    ...
    <div class="cs-side_header_in">
      ...
      <a class="cs-site_branding" href="{{ url('/') }}">
        <img src="assets/img/asquare/logo/asquare.png" alt="Logo" />
      </a>
      ...
      <div class="cs-side_header_box">
        ...
        <ul class="cs-contact_info cs-style1 cs-mp0">
          ...
          <li>
            ...
            <span>Kolkata <br />West Bengal </span>
          </li>
        </ul>
      </div>
