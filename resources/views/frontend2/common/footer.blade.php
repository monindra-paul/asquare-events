        ...
        <div class="col-lg-3 col-sm-6">
          <div class="cs-footer_item">
            <div class="cs-text_widget">
              <img src="assets/img/asquare/logo/asfooter.png" alt="footer-logo" width="180px" />
              <p> </p>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="cs-footer_item">
            ...
            <ul class="cs-menu_widget cs-mp0">
              <li>
                <a href="{{url('/eventscommunication')}}">Events & Communication</a>
              </li>
              <li>
                <a href="{{url('/kolkataphotos')}}">Kolkata Photos</a>
              </li>
              <li>
                <a href="{{url('/digital-marketing')}}">Digital marketing</a>
              </li>
              <li>
                <a href="{{url('/kolkatastudios')}}">Kolkata Studios</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="cs-footer_item">
            ...
            <ul class="cs-menu_widget cs-mp0">
              <li>Kolkata, India</li>
              <li>+91 6290950790</li>
              <li>info@teamasquare.com</li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="cs-footer_item">
            <h2 class="cs-widget_title">Have You Any Query?</h2>
            <div class="cs-newsletter cs-style1">
              <form action="{{url('/contact')}}" class="cs-newsletter_form" method="get">
  ...
  <div class="container">
    <div class="cs-bottom_footer">
      <div class="cs-bottom_footer_left">
        <div class="cs-copyright">Copyright © 2023 <span>Team Asquare.</span></div>
      </div>
      <div class="cs-bottom_footer_right">
        <ul class="cs-footer_links cs-mp0">
          <li>
            <a href="https://ecoretechserv.com" target="_blank">Developed By ECore TechServ</a>
          </li>
