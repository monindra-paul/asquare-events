    ...
    <div class="row">
      <div class="col-xl-5 col-lg-7">
        <div class="cs-section_heading cs-style1">
          <h3 class="cs-section_subtitle">About Team Asquare</h3>
          <h2 class="cs-section_title">Your trusted partner <br>for business </h2>
          <div class="cs-height_30 cs-height_lg_20"></div>
          <p class="cs-m0"> Welcome to Team Asquare our dynamic entertainment empire, where we bring your dreams to life
            through the magic of film, photography, events, and digital marketing. With a passion for creativity and a
            dedication to excellence, we offer a wide range of services that ensure your special moments are captured,
            celebrated, and shared in the most extraordinary ways.
      ...
      <div class="col-lg-5 offset-xl-2">
        <img src="{{asset('assets/img/asquare/selection.png')}}" alt="zxfg" class=" cs-radius_15">
        <div class="cs-height_25 cs-height_lg_25"></div>
      </div>
      <div class="col-lg-7">
        <img src="{{asset('assets/img/asquare/logo/asfooter.png')}}" alt="sde" class=" cs-radius_15" width="160px">
        <div class="cs-height_25 cs-height_lg_25"></div>
      </div>
      <!-- <div class="col-lg-5"> -->
      <!-- <img src="{{asset('assets/img/asquare/aw.png')}}" alt="" class="w-100 cs-radius_15"> -->
      <!-- <div class="cs-height_25 cs-height_lg_25"></div> -->
    </div>
  </div>
  </div>
      ...
      <div class="cs-funfact_left">
        <div class="cs-funfact_heading">
          ...
          <p>Together, we strive to create captivating moments, unforgettable experiences, and everlasting memories.
            Join us as we embark on a journey of imagination, artistry, and boundless creativity.
    ...
    <div class="row">
      <div class="col-xl-5 col-lg-6">
        <div class="cs-image_layer cs-style1">
          <div class="cs-image_layer_in">
            <img src="{{asset('assets/img/asquare/about-team.webp')}}" alt="Image" class="w-100 cs-radius_15">
          </div>
        </div>
      ...
      <div class="col-xl-5 offset-xl-1 col-lg-6">
        <div class="cs-section_heading cs-style1">
          ...
          <div class="cs-height_30 cs-height_lg_20"></div>
          <p class="cs-m0">Our talented team of professionals is dedicated to creating exceptional experiences and
            timeless moments. Join us as we bring your vision to life and make your dreams a reality.
          </p>
          ...
          <div class="slider-for_item">
            <div class="cs-testimonial cs-style1">
              ...
              <div class="cs-testimonial_text"> I wish I would have thought of it first. Creative agency is the most
                tech valuable business resource we have ever purchased. Dude your stuff is the bomb! eaque ipsa quae ab
                illo inventore veritatis et quasi architecto beatae vitae dicta sunt to the explicabo. </div>
