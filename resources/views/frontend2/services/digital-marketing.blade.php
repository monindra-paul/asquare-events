...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg " data-src="{{asset('assets/img/asquare/fb/digital-marketing.webp')}}">
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color bg-overlay-asquare">Digital Marketing</h1>
...
<div class="container">
    <h2 class="cs-font_38 text-center cs-m0 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Digital Marketing
    </h2>
    <div class="cs-height_60 cs-height_lg_45">
    </div>
    <p class="cs-m0 text-center" >Build your Social Media as
Online Business Platform. <br> We bet you don’t spend much time on the 2nd page of Google – so why should your website?
    </p>
...
<div class="container">
    <div class="cs-section_heading cs-style1 text-center">
        ...
        <h2 class="cs-section_title">Services</h2>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="cs-iconbox cs-style2 text-center">
                ...
                <h2 class="cs-iconbox_title">SMM</h2>
                <div class="cs-iconbox_subtitle">Social Media Marketing</div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="cs-iconbox cs-style2 text-center">
                ...
                <h2 class="cs-iconbox_title">SEO Ranking</h2>
                <div class="cs-iconbox_subtitle">Search Engine Optimization Ranking</div>
            </div>
            <div class="cs-height_30 cs-height_lg_35"></div>
        </div>
        <div class="col-lg-4">
            <div class="cs-iconbox cs-style2 text-center">
                ...
                <h2 class="cs-iconbox_title">SMO</h2>
                <div class="cs-iconbox_subtitle">Social Media Optimization
                    </div>
            </div>
            <div class="cs-height_30 cs-height_lg_35"></div>
        </div>
    ...
    <div class="row align-items-center">
        <div class="col-xl-5 col-lg-6">
            <div class="cs-radius_15 cs-shine_hover_1">
                <img class="cs-radius_15 w-100" src="{{asset('assets/img/asquare/fb/digital.webp')}}" alt="Service Image">
            </div>
            <div class="cs-height_0 cs-height_lg_40"></div>
        </div>
        <div class="col-lg-6 offset-xl-1">
            <h2 class="cs-font_50 cs-m0">Asquare Most Specilized Services</h2>
            <p>Team Asquare is well known for its SEO services. We provide best and low cost SEO services & Team Asquare is famous for its SEO service.
We use modern architectures, technical systems and trending technologies to perform best.
            </p>
                    ...
                    <ul class="cs-list cs-style1 cs-mp0">
                        ...
                        <li>
                            <a href="service-details.html" class="cs-text_btn cs-type2">
                                ...
                                <span>Goole Business Manager</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="cs-list cs-style1 cs-mp0">
                        <li>
                            <a href="service-details.html" class="cs-text_btn cs-type2">
                                ...
                                <span>Outdoor Branding - ATL-BTL Promotion</span>
                            </a>
                        </li>
                        <li>
                            <a href="service-details.html" class="cs-text_btn cs-type2">
                        ...
                        <li>
                            <a href="service-details.html" class="cs-text_btn cs-type2">
                                ...
                                <span>School &amp; College Activity</span>
                            </a>
                        </li>
