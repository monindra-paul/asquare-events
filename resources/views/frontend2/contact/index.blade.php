...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6">
            <form id="cs-form" action="{{url('/contact')}}" method="POST" class="row">
                @csrf
                ...
                @endif
                <div class="col-lg-12">
                    <label class="cs-primary_color">Write Your Message*</label>
                    <textarea cols="30" rows="7" class="cs-form_field" name="message" id="message"></textarea>
